 ...
 */
public class CustomizedLog4jHTMLLayout extends Layout {
...
//	private String timestampFormat = "yyyy-MM-dd-HH:mm:ss.SZ"; // Default format. Example: 2008-11-21-18:35:21.472-0800
	private String timestampFormat = "yyyy-MM-dd-HH:mm:ss.S"; // Default format. Example: 2008-11-21-18:35:21.472-0800
  ...
  */
  ...
  public
  String log4jFormat(LoggingEvent event) {
  ...
  */
  ...
  //============================  
	...
	public String format(LoggingEvent event) {		
		String record = log4jFormat(event); // Get the log record in the default HTMLLayout format.
